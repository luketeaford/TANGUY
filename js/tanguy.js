...
var TANGUY = {
    ...
    gate_on: function () {
        ...
        var filter_end_of_attack = parseFloat(TANGUY.voice1.currentTime + TANGUY.program.filter.attack);
        var vca_end_of_attack = parseFloat(TANGUY.voice1.currentTime + TANGUY.program.vca.attack);
